...
function findWiningBoard(numbers, boards){
...
function main () {
    const data = getFileLines("day-4/test.txt")
    ...
    const [wonBoard, boardMasks, lastNumber] = findWiningBoard(numbers, boards)

    console.log(wonBoard, lastNumber)
